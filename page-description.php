      ...
      <div class="p-description__content">
        ...
        <section class="p-description__section p-description__section--hospitality">
          ...
          <p class="p-description__bodyText">
            私たちが選んだのは、国内最高峰のミニバン「トヨタ アルファード」。<br>
    ...
    <div class="l-inner">
      <div class="p-flow__content">
        ...
        <p class="p-flow__lead">
          お客様がUberアプリで配車を依頼すると、最も近いドライバーへ通知が届きます。ドライバーはナビを使って迷わずお迎えに向かい、乗車後はアプリが自動で行き先を表示。降車時も料金は料金がアプリで自動計算され、決裁まで完了するので、現金のやり取りは一切不要です。会社貸与のiPad<br class="u-mobile">
