          ...
          <?php foreach ($interview_items as $item) : ?>
            <article class="p-interview__item">
              <figure class="p-interview__media">
                <video
                  class="p-interview__video"
                  controls
                  playsinline
                  preload="none"
                  poster="<?php echo esc_url(get_template_directory_uri()); ?>/images/page/interview/<?php echo esc_attr($item['image']); ?>"
