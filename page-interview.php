...
$interview_items = [
  [
    ...
    'youtube_url' => 'https://www.youtube.com/embed/41rwLv8DBbw?si=GryPTBF8WL2ELSAO',
  ],
  [
    'number' => 'No.02',
    'title' => "元・海上自衛隊\n17年勤務、今は自分らしく働けています",
    'description' => "海上自衛隊で約17年。教育隊の分隊長として責任ある役割も経験してきた上野さん。\n当時の時間を否定せず、むしろ「組織の中で学ぶ経験は人生に活きる」と話します。\nそれでも、ふと立ち止まった日があった。\n「“上野智子として”何かできていたのか」。\nこの動画は、逃げではなく“次の挑戦”として選んだ転職の記録です。",
    'youtube_url' => 'https://www.youtube.com/embed/ZML27D0-aPM?si=4DVSRtUShdWXeDF8',
  ],
  [
    'number' => 'No.03',
    'title' => "25歳からハイヤー業界に\n飛び込んだ、元・電気店店員。",
    ...
    'youtube_url' => 'https://www.youtube.com/embed/60lnQRidiVc?si=BerdKyOf4hXs4fOt',
  ],
  [
    'number' => 'No.04',
    'title' => "5年目、\nハイヤードライバー\n佐野さん",
    'description' => "佐野さんが働き方を見直した理由は、収入でもキャリアでもありません。\nきっかけは、家族との時間。\n忙しい日々の中で、ふと立ち止まった瞬間に気づいたことがあった。\n「もっと一緒に過ごせたんじゃないか」。\nこの動画は、“今を大切にする”という価値観が、働き方を変えていく記録です。",
    'youtube_url' => 'https://www.youtube.com/embed/T65aAifnq0I?si=E6e3Jnx0w3OccTEC',
  ],
  [
    'number' => 'No.05',
    ...
    'youtube_url' => 'https://www.youtube.com/embed/0Fy5gFfwoPY?si=A8gBdqPb5FjMXckZ',
  ],
];
